...
def StochasticLanczosQuadratureMethod(
    ...
    """
    Computes deg-determinant of matrix based on stochastic Lanczos quadrature method.
...
cpdef double _StochasticLanczosQuadratureMethod(
    ...
    cdef double[:] LogDetEstimates = numpy.zeros((NumIterations,),dtype=float)
