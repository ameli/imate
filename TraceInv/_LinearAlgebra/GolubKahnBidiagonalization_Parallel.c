...
/* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":23
 * @boundscheck(False)
 * @wraparound(False)
...
static int __pyx_f_8TraceInv_14_LinearAlgebra_35GolubKahnBidiagonalization_Parallel_GolubKahnBidiagonalization(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_A_Data, __Pyx_memviewslice __pyx_v_A_ColumnIndices, __Pyx_memviewslice __pyx_v_A_IndexPointer, __Pyx_memviewslice __pyx_v_v, int const __pyx_v_n, int const __pyx_v_m, double const __pyx_v_Tolerance, __Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_beta) {
  ...
  /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":132
 *     cdef int UseSparse
 *     cdef int i,k
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":137
 *     if A is None:
 *         if (A_Data is None) or (A_ColumnIndices is None) or (A_IndexPointer is None):
 *             printf('ERROR: All components of sparse matrix are not provided.\n')             # <<<<<<<<<<<<<<
 *             fflush(stdout)
 *             exit(1)
 */
      (void)(printf(((char const *)"ERROR: All components of sparse matrix are not provided.\n")));
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":139
 *             printf('ERROR: All components of sparse matrix are not provided.\n')
 *             fflush(stdout)
 *             exit(1)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":141
 *             exit(1)
 *         else:
 *             UseSparse = 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":147
 *     # Allocate vectors v_old, v_new, u_old, and u_new
 *     cdef double* v_old = <double*> malloc(sizeof(double)*n)
 *     cdef double* v_new = <double*> malloc(sizeof(double)*n)             # <<<<<<<<<<<<<<
 *     cdef double* u_old = <double*> malloc(sizeof(double)*n)
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":148
 *     cdef double* v_old = <double*> malloc(sizeof(double)*n)
 *     cdef double* v_new = <double*> malloc(sizeof(double)*n)
 *     cdef double* u_old = <double*> malloc(sizeof(double)*n)             # <<<<<<<<<<<<<<
 *     cdef double* u_new = <double*> malloc(sizeof(double)*n)
 ...
 */
  __pyx_t_3 = 0;
  (void)(__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorAndCopy((&(*((double const  *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_3 * __pyx_v_v.strides[0]) )))), __pyx_v_n, __pyx_v_v_old));
 ...
 */
  __pyx_t_3 = 0;
  *((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) )) = 0.0;
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":164
 * 
 *         # u_new = A.dot(v_old)
 *         if UseSparse:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":171
 *             DenseMatrixVectorMultiplication(A,v_old,n,n,u_new)
 * 
 *         if k > 0:             # <<<<<<<<<<<<<<
 *             for i in range(n):
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":172
 * 
 *         if k > 0:
 *             for i in range(n):             # <<<<<<<<<<<<<<
 *                 u_new[i] = u_new[i] - beta[k]*u_old[i]
 ...
 */
        __pyx_t_3 = __pyx_v_k;
        (__pyx_v_u_new[__pyx_v_i]) = ((__pyx_v_u_new[__pyx_v_i]) - ((*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) ))) * (__pyx_v_u_old[__pyx_v_i])));
      }
 ...
 */
    __pyx_t_3 = __pyx_v_k;
    *((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_3 * __pyx_v_alpha.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorInPlace(__pyx_v_u_new, __pyx_v_n);

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":179
 * 
 *         # v_new is A.u_new - alpha[k].v_old
 *         if UseSparse:             # <<<<<<<<<<<<<<
 *             # Sparse matrix-vector multiplication
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":186
 *             DenseMatrixVectorMultiplication(A,u_new,n,n,v_new)
 * 
 *         for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_3 = __pyx_v_k;
      (__pyx_v_v_new[__pyx_v_i]) = ((__pyx_v_v_new[__pyx_v_i]) - ((*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_3 * __pyx_v_alpha.strides[0]) ))) * (__pyx_v_v_old[__pyx_v_i])));
    }
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm(__pyx_v_v_new, __pyx_v_n);
 ...
 */
    __pyx_t_3 = (__pyx_v_k + 1);
    __pyx_t_1 = (((*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) ))) < __pyx_v_Tolerance) != 0);
    if (__pyx_t_1) {
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":195
 *         if beta[k+1] < Tolerance:
 *             if k == 0:
 *                 printf('Premature exit in Golub-Kahn-Lanczos bi-diagonalization. Probably A is close to identity. alpha[0]: %e, beta[1]: %e, Tolerance: %e',alpha[0],beta[1],Tolerance)             # <<<<<<<<<<<<<<
 *                 fflush(stdout)
 ...
 */
        __pyx_t_3 = 0;
        __pyx_t_10 = 1;
        (void)(printf(((char const *)"Premature exit in Golub-Kahn-Lanczos bi-diagonalization. Probably A is close to identity. alpha[0]: %e, beta[1]: %e, Tolerance: %e"), (*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_3 * __pyx_v_alpha.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_10 * __pyx_v_beta.strides[0]) ))), __pyx_v_Tolerance));

        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":196
 *             if k == 0:
 *                 printf('Premature exit in Golub-Kahn-Lanczos bi-diagonalization. Probably A is close to identity. alpha[0]: %e, beta[1]: %e, Tolerance: %e',alpha[0],beta[1],Tolerance)
 *                 fflush(stdout)             # <<<<<<<<<<<<<<
 *             break
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":200
 * 
 *         # Scale v_new by 1/beta[k+1]
 *         for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      (__pyx_v_v_new[__pyx_v_i]) = ((__pyx_v_v_new[__pyx_v_i]) / (*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_10 * __pyx_v_beta.strides[0]) ))));
    }

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":204
 * 
 *         # Update for new iteration
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":209
 *     # Free dynamic memory
 *     free(v_old)
 *     free(v_new)             # <<<<<<<<<<<<<<
 *     free(u_old)
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":211
 *     free(v_new)
 *     free(u_old)
 *     free(u_new)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":213
 *     free(u_new)
 * 
 *     return LanczosCounter             # <<<<<<<<<<<<<<
 */
