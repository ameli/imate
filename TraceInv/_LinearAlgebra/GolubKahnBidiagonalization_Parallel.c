...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "./TraceInv/_LinearAlgebra"
        ],
        "name": "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel",
        "sources": [
            "/home/sia/work/ADCP/Noise-Estimation/code/TraceInv/TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx"
        ]
    },
    "module_name": "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel"
}
END: Cython Metadata */
...
#define __PYX_HAVE__TraceInv___LinearAlgebra__GolubKahnBidiagonalization_Parallel
#define __PYX_HAVE_API__TraceInv___LinearAlgebra__GolubKahnBidiagonalization_Parallel
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx",
  "stringsource",
};
...
static void (*__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CopyVector)(double const *, int const , double *); /*proto*/
static double (*__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm)(double const *, int const ); /*proto*/
static double (*__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorInPlace)(double *, int const ); /*proto*/
static double (*__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorAndCopy)(double const *, int const , double *); /*proto*/
static void (*__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_DenseMatrixVectorMultiplication)(__Pyx_memviewslice, double const *, int const , int const , double *); /*proto*/
static void (*__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_SparseMatrixVectorMultiplication)(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double const *, int const , double *); /*proto*/
...
#define __Pyx_MODULE_NAME "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel"
extern int __pyx_module_is_main_TraceInv___LinearAlgebra__GolubKahnBidiagonalization_Parallel;
int __pyx_module_is_main_TraceInv___LinearAlgebra__GolubKahnBidiagonalization_Parallel = 0;

/* Implementation of 'TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel' */
...
/* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":22
 * @boundscheck(False)
 * @wraparound(False)
...
static int __pyx_f_8TraceInv_14_LinearAlgebra_35GolubKahnBidiagonalization_Parallel_GolubKahnBidiagonalization(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_A_Data, __Pyx_memviewslice __pyx_v_A_ColumnIndices, __Pyx_memviewslice __pyx_v_A_IndexPointer, __Pyx_memviewslice __pyx_v_v, int const __pyx_v_n, int const __pyx_v_m, double const __pyx_v_Tolerance, __Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_beta) {
  int __pyx_v_UseSparse;
  int __pyx_v_i;
  int __pyx_v_k;
  int __pyx_v_LanczosCounter;
  double *__pyx_v_v_old;
  double *__pyx_v_v_new;
  double *__pyx_v_u_old;
  double *__pyx_v_u_new;
  int __pyx_r;
  ...
  #endif
  __Pyx_RefNannySetupContext("GolubKahnBidiagonalization", 1);

  /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":33
 *         double[:] alpha,
 *         double[:] beta) nogil:
 *     """             # <<<<<<<<<<<<<<
 ...
 */
  /*try:*/ {
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":131
 *     cdef int UseSparse
 *     cdef int i,k
 ...
 */
    __pyx_v_LanczosCounter = 0;

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":134
 * 
 *     # Check if the input matrix is sparse
 *     if A is None:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":135
 *     # Check if the input matrix is sparse
 *     if A is None:
 *         if (A_Data is None) or (A_ColumnIndices is None) or (A_IndexPointer is None):             # <<<<<<<<<<<<<<
 *             raise ValueError('All components of sparse matrix are not provided.')
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":136
 *     if A is None:
 *         if (A_Data is None) or (A_ColumnIndices is None) or (A_IndexPointer is None):
 *             raise ValueError('All components of sparse matrix are not provided.')             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        {
            ...
            #endif
            /*try:*/ {
              __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 136, __pyx_L12_error)
              __Pyx_GOTREF(__pyx_t_3);
              __Pyx_Raise(__pyx_t_3, 0, 0, 0);
              __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
              __PYX_ERR(0, 136, __pyx_L12_error)
            }
            /*finally:*/ {
              __pyx_L12_error: {
                #ifdef WITH_THREAD
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":138
 *             raise ValueError('All components of sparse matrix are not provided.')
 *         else:
 *             UseSparse = 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":140
 *             UseSparse = 1
 *     else:
 *         UseSparse = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":143
 * 
 *     # Allocate vectors v_old, v_new, u_old, and u_new
 ...
 */
    __pyx_v_v_old = ((double *)malloc(((sizeof(double)) * __pyx_v_n)));

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":144
 *     # Allocate vectors v_old, v_new, u_old, and u_new
 *     cdef double* v_old = <double*> malloc(sizeof(double)*n)
 *     cdef double* v_new = <double*> malloc(sizeof(double)*n)             # <<<<<<<<<<<<<<
 *     cdef double* u_old = <double*> malloc(sizeof(double)*n)
 ...
 */
    __pyx_v_v_new = ((double *)malloc(((sizeof(double)) * __pyx_v_n)));

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":145
 *     cdef double* v_old = <double*> malloc(sizeof(double)*n)
 *     cdef double* v_new = <double*> malloc(sizeof(double)*n)
 *     cdef double* u_old = <double*> malloc(sizeof(double)*n)             # <<<<<<<<<<<<<<
 *     cdef double* u_new = <double*> malloc(sizeof(double)*n)
 * 
 */
    __pyx_v_u_old = ((double *)malloc(((sizeof(double)) * __pyx_v_n)));

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":146
 *     cdef double* v_new = <double*> malloc(sizeof(double)*n)
 *     cdef double* u_old = <double*> malloc(sizeof(double)*n)
 *     cdef double* u_new = <double*> malloc(sizeof(double)*n)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_u_new = ((double *)malloc(((sizeof(double)) * __pyx_v_n)));

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":149
 * 
 *     # Normalize vector v and copy to v_old
 ...
 */
    __pyx_t_4 = 0;
    (void)(__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorAndCopy((&(*((double const  *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_4 * __pyx_v_v.strides[0]) )))), __pyx_v_n, __pyx_v_v_old));

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":152
 * 
 *     # Initialize beta[0]
 *     beta[0] = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_4 = 0;
    *((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) )) = 0.0;

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":155
 * 
 *     # Golub-Kahn iteration
 *     for k in range(m):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":158
 * 
 *         # Counter for the non-zero size of alpha and beta
 *         LanczosCounter += 1             # <<<<<<<<<<<<<<
 * 
 *         # u_new = A.dot(v_old)
 */
      __pyx_v_LanczosCounter = (__pyx_v_LanczosCounter + 1);

      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":161
 * 
 *         # u_new = A.dot(v_old)
 *         if UseSparse:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":163
 *         if UseSparse:
 *             # Sparse matrix-vector multiplication
 *             SparseMatrixVectorMultiplication(A_Data,A_ColumnIndices,A_IndexPointer,v_old,n,u_new)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_SparseMatrixVectorMultiplication(__pyx_v_A_Data, __pyx_v_A_ColumnIndices, __pyx_v_A_IndexPointer, __pyx_v_v_old, __pyx_v_n, __pyx_v_u_new);
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":166
 *         else:
 *             # Dense matrix-vector multiplication
 ...
 */
      /*else*/ {
        __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_DenseMatrixVectorMultiplication(__pyx_v_A, __pyx_v_v_old, __pyx_v_n, __pyx_v_n, __pyx_v_u_new);
      }
      __pyx_L16:;

      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":168
 *             DenseMatrixVectorMultiplication(A,v_old,n,n,u_new)
 * 
 *         if k > 0:             # <<<<<<<<<<<<<<
 *             for i in range(n):
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":169
 * 
 *         if k > 0:
 *             for i in range(n):             # <<<<<<<<<<<<<<
 *                 u_new[i] = u_new[i] - beta[k]*u_old[i]
 ...
 */
        ...
        for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
          ...
          /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":170
 *         if k > 0:
 *             for i in range(n):
 *                 u_new[i] = u_new[i] - beta[k]*u_old[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_4 = __pyx_v_k;
          (__pyx_v_u_new[__pyx_v_i]) = ((__pyx_v_u_new[__pyx_v_i]) - ((*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) ))) * (__pyx_v_u_old[__pyx_v_i])));
        }
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":173
 * 
 *         # Normalize u_new and set its norm to alpha[k]
 ...
 */
      __pyx_t_4 = __pyx_v_k;
      *((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_4 * __pyx_v_alpha.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorInPlace(__pyx_v_u_new, __pyx_v_n);

      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":176
 * 
 *         # v_new is A.u_new - alpha[k].v_old
 *         if UseSparse:             # <<<<<<<<<<<<<<
 *             # Sparse matrix-vector multiplication
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":178
 *         if UseSparse:
 *             # Sparse matrix-vector multiplication
 *             SparseMatrixVectorMultiplication(A_Data,A_ColumnIndices,A_IndexPointer,u_new,n,v_new)             # <<<<<<<<<<<<<<
 *         else:
 *             # Dense matrix-vector multiplication
 */
        __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_SparseMatrixVectorMultiplication(__pyx_v_A_Data, __pyx_v_A_ColumnIndices, __pyx_v_A_IndexPointer, __pyx_v_u_new, __pyx_v_n, __pyx_v_v_new);
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":181
 *         else:
 *             # Dense matrix-vector multiplication
 ...
 */
      /*else*/ {
        __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_DenseMatrixVectorMultiplication(__pyx_v_A, __pyx_v_u_new, __pyx_v_n, __pyx_v_n, __pyx_v_v_new);
      }
      __pyx_L20:;

      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":183
 *             DenseMatrixVectorMultiplication(A,u_new,n,n,v_new)
 * 
 *         for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":184
 * 
 *         for i in range(n):
 *             v_new[i] = v_new[i] - alpha[k]*v_old[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_4 = __pyx_v_k;
        (__pyx_v_v_new[__pyx_v_i]) = ((__pyx_v_v_new[__pyx_v_i]) - ((*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_4 * __pyx_v_alpha.strides[0]) ))) * (__pyx_v_v_old[__pyx_v_i])));
      }

      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":187
 * 
 *         # Update beta as the norm of v_new
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm(__pyx_v_v_new, __pyx_v_n);

      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":190
 * 
 *         # Exit criterion
 ...
 */
      __pyx_t_4 = (__pyx_v_k + 1);
      __pyx_t_1 = (((*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) ))) < __pyx_v_Tolerance) != 0);
      if (__pyx_t_1) {

        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":191
 *         # Exit criterion
 *         if beta[k+1] < Tolerance:
 *             if k == 0:             # <<<<<<<<<<<<<<
 *                 printf('Premature exit in Golub-Kahn-Lanczos bi-diagonalization. Probably A is close to identity. alpha[0]: %e, beta[1]: %e, Tolerance: %e',alpha[0],beta[1],Tolerance)
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":192
 *         if beta[k+1] < Tolerance:
 *             if k == 0:
 *                 printf('Premature exit in Golub-Kahn-Lanczos bi-diagonalization. Probably A is close to identity. alpha[0]: %e, beta[1]: %e, Tolerance: %e',alpha[0],beta[1],Tolerance)             # <<<<<<<<<<<<<<
 *                 fflush(stdout)
 ...
 */
          __pyx_t_4 = 0;
          __pyx_t_11 = 1;
          (void)(printf(((char const *)"Premature exit in Golub-Kahn-Lanczos bi-diagonalization. Probably A is close to identity. alpha[0]: %e, beta[1]: %e, Tolerance: %e"), (*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_4 * __pyx_v_alpha.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_11 * __pyx_v_beta.strides[0]) ))), __pyx_v_Tolerance));

          /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":193
 *             if k == 0:
 *                 printf('Premature exit in Golub-Kahn-Lanczos bi-diagonalization. Probably A is close to identity. alpha[0]: %e, beta[1]: %e, Tolerance: %e',alpha[0],beta[1],Tolerance)
 *                 fflush(stdout)             # <<<<<<<<<<<<<<
 *             break
 ...
 */
        ...
        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":194
 *                 printf('Premature exit in Golub-Kahn-Lanczos bi-diagonalization. Probably A is close to identity. alpha[0]: %e, beta[1]: %e, Tolerance: %e',alpha[0],beta[1],Tolerance)
 *                 fflush(stdout)
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":197
 * 
 *         # Scale v_new by 1/beta[k+1]
 *         for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":198
 *         # Scale v_new by 1/beta[k+1]
 *         for i in range(n):
 *             v_new[i] = v_new[i] / beta[k+1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        (__pyx_v_v_new[__pyx_v_i]) = ((__pyx_v_v_new[__pyx_v_i]) / (*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_11 * __pyx_v_beta.strides[0]) ))));
      }

      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":201
 * 
 *         # Update for new iteration
 ...
 * 
 */
      __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CopyVector(__pyx_v_v_new, __pyx_v_n, __pyx_v_v_old);

      /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":202
 *         # Update for new iteration
 *         CopyVector(v_new,n,v_old)
 *         CopyVector(u_new,n,u_old)             # <<<<<<<<<<<<<<
 * 
 *     # Free dynamic memory
 */
      __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CopyVector(__pyx_v_u_new, __pyx_v_n, __pyx_v_u_old);
    }
    __pyx_L15_break:;

    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":205
 * 
 *     # Free dynamic memory
 *     free(v_old)             # <<<<<<<<<<<<<<
 *     free(v_new)
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":206
 *     # Free dynamic memory
 *     free(v_old)
 *     free(v_new)             # <<<<<<<<<<<<<<
 *     free(u_old)
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":207
 *     free(v_old)
 *     free(v_new)
 *     free(u_old)             # <<<<<<<<<<<<<<
 *     free(u_new)
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":208
 *     free(v_new)
 *     free(u_old)
 *     free(u_new)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":210
 *     free(u_new)
 * 
 *     return LanczosCounter             # <<<<<<<<<<<<<<
 */
    __pyx_r = __pyx_v_LanczosCounter;
 ...
 */
  ...
  __Pyx_WriteUnraisable("TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel.GolubKahnBidiagonalization", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  #ifdef WITH_THREAD
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_GolubKahnBidiagonalization_Parallel(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_GolubKahnBidiagonalization_Parallel},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "GolubKahnBidiagonalization_Parallel",
    0, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
 ...
 *             UseSparse = 1
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_All_components_of_sparse_matrix); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 136, __pyx_L1_error)
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "CopyVector", (void (**)(void))&__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CopyVector, "void (double const *, int const , double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "EuclideanNorm", (void (**)(void))&__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm, "double (double const *, int const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "NormalizeVectorInPlace", (void (**)(void))&__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorInPlace, "double (double *, int const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "NormalizeVectorAndCopy", (void (**)(void))&__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorAndCopy, "double (double const *, int const , double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "DenseMatrixVectorMultiplication", (void (**)(void))&__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_DenseMatrixVectorMultiplication, "void (__Pyx_memviewslice, double const *, int const , int const , double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "SparseMatrixVectorMultiplication", (void (**)(void))&__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_SparseMatrixVectorMultiplication, "void (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double const *, int const , double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initGolubKahnBidiagonalization_Parallel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initGolubKahnBidiagonalization_Parallel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_GolubKahnBidiagonalization_Parallel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_GolubKahnBidiagonalization_Parallel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_GolubKahnBidiagonalization_Parallel(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'GolubKahnBidiagonalization_Parallel' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_GolubKahnBidiagonalization_Parallel(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("GolubKahnBidiagonalization_Parallel", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_TraceInv___LinearAlgebra__GolubKahnBidiagonalization_Parallel) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel")) {
      if (unlikely(PyDict_SetItemString(modules, "TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "TraceInv/_LinearAlgebra/GolubKahnBidiagonalization_Parallel.pyx":1
 * # =======             # <<<<<<<<<<<<<<
 * # Imports
 * # =======
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init TraceInv._LinearAlgebra.GolubKahnBidiagonalization_Parallel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
