...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "TraceInv._LinearAlgebra.MatrixOperations",
        "sources": [
            "/home/sia/work/ADCP/Noise-Estimation/code/TraceInv/TraceInv/_LinearAlgebra/MatrixOperations.pyx"
        ]
    },
    "module_name": "TraceInv._LinearAlgebra.MatrixOperations"
}
END: Cython Metadata */
...
#define __PYX_HAVE__TraceInv___LinearAlgebra__MatrixOperations
#define __PYX_HAVE_API__TraceInv___LinearAlgebra__MatrixOperations
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
static const char *__pyx_f[] = {
  "TraceInv/_LinearAlgebra/MatrixOperations.pyx",
  "stringsource",
};
...
#define __Pyx_MODULE_NAME "TraceInv._LinearAlgebra.MatrixOperations"
extern int __pyx_module_is_main_TraceInv___LinearAlgebra__MatrixOperations;
int __pyx_module_is_main_TraceInv___LinearAlgebra__MatrixOperations = 0;

/* Implementation of 'TraceInv._LinearAlgebra.MatrixOperations' */
...
/* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":14
 * @boundscheck(False)
 * @wraparound(False)
...
static void __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CopyVector(double const *__pyx_v_InputVector, int const __pyx_v_n, double *__pyx_v_OutputVector) {
  int __pyx_v_i;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;

  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":32
 * 
 *     cdef int i
 *     for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":33
 *     cdef int i
 *     for i in range(n):
 *         OutputVector[i] = InputVector[i]             # <<<<<<<<<<<<<<
 * 
 * # =============
 */
    (__pyx_v_OutputVector[__pyx_v_i]) = (__pyx_v_InputVector[__pyx_v_i]);
  }
...
/* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":41
 * @boundscheck(False)
 * @wraparound(False)
...
static double __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_InnerProduct(double const *__pyx_v_Vector1, double const *__pyx_v_Vector2, int const __pyx_v_VectorLength) {
  int __pyx_v_i;
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":62
 * 
 *     cdef int i
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":64
 *     cdef double InnerProd = 0.0
 * 
 *     for i in range(VectorLength):             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = __pyx_v_VectorLength;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":65
 * 
 *     for i in range(VectorLength):
 *         InnerProd += Vector1[i]*Vector2[i]             # <<<<<<<<<<<<<<
 * 
 *     return InnerProd
 */
    __pyx_v_InnerProd = (__pyx_v_InnerProd + ((__pyx_v_Vector1[__pyx_v_i]) * (__pyx_v_Vector2[__pyx_v_i])));
  }

  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":67
 *         InnerProd += Vector1[i]*Vector2[i]
 * 
 *     return InnerProd             # <<<<<<<<<<<<<<
 * 
...
/* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":75
 * @boundscheck(False)
 * @wraparound(False)
...
static double __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm(double const *__pyx_v_Vector, int const __pyx_v_VectorLength) {
  double __pyx_v_Norm2;
  double __pyx_v_Norm;
  double __pyx_r;

  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":92
 * 
 ...
 *     # Norm
 */
  __pyx_v_Norm2 = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_InnerProduct(__pyx_v_Vector, __pyx_v_Vector, __pyx_v_VectorLength);

  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":95
 * 
 *     # Norm
 *     Norm = sqrt(Norm2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":97
 *     Norm = sqrt(Norm2)
 * 
 *     return Norm             # <<<<<<<<<<<<<<
 * 
...
/* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":105
 * @boundscheck(False)
 * @wraparound(False)
...
static double __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorInPlace(double *__pyx_v_Vector, int const __pyx_v_VectorLength) {
  int __pyx_v_i;
  double __pyx_v_Norm;
  double __pyx_r;
  int __pyx_t_1;
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":124
 * 
 *     # Norm of vector
 ...
 *     # Normalize
 */
  __pyx_v_Norm = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm(__pyx_v_Vector, __pyx_v_VectorLength);

  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":127
 * 
 *     # Normalize
 *     for i in range(VectorLength):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":128
 *     # Normalize
 *     for i in range(VectorLength):
 *         Vector[i] = Vector[i] / Norm             # <<<<<<<<<<<<<<
 * 
 *     return Norm
 */
    (__pyx_v_Vector[__pyx_v_i]) = ((__pyx_v_Vector[__pyx_v_i]) / __pyx_v_Norm);
  }

  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":130
 *         Vector[i] = Vector[i] / Norm
 * 
 *     return Norm             # <<<<<<<<<<<<<<
 * 
...
/* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":138
 * @boundscheck(False)
 * @wraparound(False)
...
static double __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorAndCopy(double const *__pyx_v_Vector, int const __pyx_v_VectorLength, double *__pyx_v_OutputVector) {
  int __pyx_v_i;
  double __pyx_v_Norm;
  double __pyx_r;
  int __pyx_t_1;
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":161
 * 
 *     # Norm of vector
 *     cdef double Norm = EuclideanNorm(Vector,VectorLength)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":164
 * 
 *     # Normalize
 *     for i in range(VectorLength):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":165
 *     # Normalize
 *     for i in range(VectorLength):
 *         OutputVector[i] = Vector[i] / Norm             # <<<<<<<<<<<<<<
 * 
 *     return Norm
 */
    (__pyx_v_OutputVector[__pyx_v_i]) = ((__pyx_v_Vector[__pyx_v_i]) / __pyx_v_Norm);
  }

  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":167
 *         OutputVector[i] = Vector[i] / Norm
 * 
 *     return Norm             # <<<<<<<<<<<<<<
 * 
...
/* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":175
 * @boundscheck(False)
 * @wraparound(False)
...
static void __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_DenseMatrixVectorMultiplication(__Pyx_memviewslice __pyx_v_A, double const *__pyx_v_b, int const __pyx_v_NumRows, int const __pyx_v_NumColumns, double *__pyx_v_c) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":202
 *     cdef int i,j
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":203
 * 
 *     for i in range(NumRows):
 *         c[i] = 0.0             # <<<<<<<<<<<<<<
 *         for j in range(NumColumns):
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":204
 *     for i in range(NumRows):
 *         c[i] = 0.0
 *         for j in range(NumColumns):             # <<<<<<<<<<<<<<
 *             c[i] = c[i] + A[i,j]*b[j]
 * 
 */
    __pyx_t_4 = __pyx_v_NumColumns;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":205
 *         c[i] = 0.0
 *         for j in range(NumColumns):
 *             c[i] = c[i] + A[i,j]*b[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_j;
      (__pyx_v_c[__pyx_v_i]) = ((__pyx_v_c[__pyx_v_i]) + ((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_A.data + __pyx_t_7 * __pyx_v_A.strides[0]) )) + __pyx_t_8)) ))) * (__pyx_v_b[__pyx_v_j])));
    }
  }
...
/* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":213
 * @boundscheck(False)
 * @wraparound(False)
...
static void __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_SparseMatrixVectorMultiplication(__Pyx_memviewslice __pyx_v_A_Data, __Pyx_memviewslice __pyx_v_A_ColumnIndices, __Pyx_memviewslice __pyx_v_A_IndexPointer, double const *__pyx_v_b, int const __pyx_v_NumRows, double *__pyx_v_c) {
  int __pyx_v_Row;
  int __pyx_v_IndexPointer;
  int __pyx_v_Column;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":252
 *     cdef int Column
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":253
 * 
 *     for Row in range(NumRows):
 *         c[Row] = 0.0             # <<<<<<<<<<<<<<
 *         for IndexPointer in range(A_IndexPointer[Row],A_IndexPointer[Row+1]):
 ...
 */
    (__pyx_v_c[__pyx_v_Row]) = 0.0;

    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":254
 *     for Row in range(NumRows):
 *         c[Row] = 0.0
 *         for IndexPointer in range(A_IndexPointer[Row],A_IndexPointer[Row+1]):             # <<<<<<<<<<<<<<
 *             Column = A_ColumnIndices[IndexPointer]
 ...
 */
    ...
    __pyx_t_5 = (*((int const  *) ( /* dim=0 */ (__pyx_v_A_IndexPointer.data + __pyx_t_4 * __pyx_v_A_IndexPointer.strides[0]) )));
    __pyx_t_4 = __pyx_v_Row;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = (*((int const  *) ( /* dim=0 */ (__pyx_v_A_IndexPointer.data + __pyx_t_4 * __pyx_v_A_IndexPointer.strides[0]) ))); __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_IndexPointer = __pyx_t_7;

      /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":255
 *         c[Row] = 0.0
 *         for IndexPointer in range(A_IndexPointer[Row],A_IndexPointer[Row+1]):
 *             Column = A_ColumnIndices[IndexPointer]             # <<<<<<<<<<<<<<
 *             c[Row] = c[Row] + A_Data[IndexPointer]*b[Column]
 * 
 */
      __pyx_t_8 = __pyx_v_IndexPointer;
      __pyx_v_Column = (*((int const  *) ( /* dim=0 */ (__pyx_v_A_ColumnIndices.data + __pyx_t_8 * __pyx_v_A_ColumnIndices.strides[0]) )));

      /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":256
 *         for IndexPointer in range(A_IndexPointer[Row],A_IndexPointer[Row+1]):
 *             Column = A_ColumnIndices[IndexPointer]
 *             c[Row] = c[Row] + A_Data[IndexPointer]*b[Column]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_8 = __pyx_v_IndexPointer;
      (__pyx_v_c[__pyx_v_Row]) = ((__pyx_v_c[__pyx_v_Row]) + ((*((double const  *) ( /* dim=0 */ (__pyx_v_A_Data.data + __pyx_t_8 * __pyx_v_A_Data.strides[0]) ))) * (__pyx_v_b[__pyx_v_Column])));
    }
  }
...
/* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":262
 * # ==================
 * 
...
static void __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CreateBandMatrix(__Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_beta, int const __pyx_v_NonZeroSize, int const __pyx_v_TridiagonalFlag, __Pyx_memviewslice __pyx_v_T) {
  int __pyx_v_j;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":302
 *     cdef int j
 * 
 ...
 *         # Diagonals
 */
  __pyx_t_1 = __pyx_v_NonZeroSize;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_j = __pyx_t_3;

    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":305
 * 
 *         # Diagonals
 *         T[j,j] = alpha[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_5 = __pyx_v_j;
    __pyx_t_6 = __pyx_v_j;
    *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_T.data + __pyx_t_5 * __pyx_v_T.strides[0]) )) + __pyx_t_6)) )) = (*((double const  *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_4 * __pyx_v_alpha.strides[0]) )));

    /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":308
 * 
 *         # Off diagonals
 *         if j < NonZeroSize-1:             # <<<<<<<<<<<<<<
 * 
 *             # Upper off-diagonal
 */
    __pyx_t_7 = ((__pyx_v_j < (__pyx_v_NonZeroSize - 1)) != 0);
    if (__pyx_t_7) {

      /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":311
 * 
 *             # Upper off-diagonal
 *             T[j,j+1] = beta[j+1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_T.data + __pyx_t_6 * __pyx_v_T.strides[0]) )) + __pyx_t_5)) )) = (*((double const  *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) )));

      /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":314
 * 
 *             # Lower off-diagonal, making tri-diagonal matrix
 *             if TridiagonalFlag:             # <<<<<<<<<<<<<<
 *                 T[j+1,j] = beta[j+1]
 */
      __pyx_t_7 = (__pyx_v_TridiagonalFlag != 0);
      if (__pyx_t_7) {

        /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":315
 *             # Lower off-diagonal, making tri-diagonal matrix
 *             if TridiagonalFlag:
 *                 T[j+1,j] = beta[j+1]             # <<<<<<<<<<<<<<
 */
        ...
        __pyx_t_5 = (__pyx_v_j + 1);
        __pyx_t_6 = __pyx_v_j;
        *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_T.data + __pyx_t_5 * __pyx_v_T.strides[0]) )) + __pyx_t_6)) )) = (*((double const  *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) )));
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "TraceInv._LinearAlgebra.MatrixOperations.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.MatrixOperations.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.MatrixOperations.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.MatrixOperations._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_MatrixOperations(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_MatrixOperations},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("CopyVector", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CopyVector, "void (double const *, int const , double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("InnerProduct", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_InnerProduct, "double (double const *, double const *, int const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("EuclideanNorm", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm, "double (double const *, int const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("NormalizeVectorInPlace", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorInPlace, "double (double *, int const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("NormalizeVectorAndCopy", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_NormalizeVectorAndCopy, "double (double const *, int const , double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("DenseMatrixVectorMultiplication", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_DenseMatrixVectorMultiplication, "void (__Pyx_memviewslice, double const *, int const , int const , double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("SparseMatrixVectorMultiplication", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_SparseMatrixVectorMultiplication, "void (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double const *, int const , double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("CreateBandMatrix", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CreateBandMatrix, "void (__Pyx_memviewslice, __Pyx_memviewslice, int const , int const , __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initMatrixOperations(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initMatrixOperations(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_MatrixOperations(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_MatrixOperations(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_MatrixOperations(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'MatrixOperations' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_MatrixOperations(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("MatrixOperations", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_TraceInv___LinearAlgebra__MatrixOperations) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "TraceInv._LinearAlgebra.MatrixOperations")) {
      if (unlikely(PyDict_SetItemString(modules, "TraceInv._LinearAlgebra.MatrixOperations", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "TraceInv/_LinearAlgebra/MatrixOperations.pyx":1
 * # =======             # <<<<<<<<<<<<<<
 * # Imports
 * # =======
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init TraceInv._LinearAlgebra.MatrixOperations", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init TraceInv._LinearAlgebra.MatrixOperations");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
