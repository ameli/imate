...
/* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":22
 * @boundscheck(False)
 * @wraparound(False)
...
static int __pyx_f_8TraceInv_14_LinearAlgebra_34LanczosTridiagonalization_Parallel_LanczosTridiagonalization(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_A_Data, __Pyx_memviewslice __pyx_v_A_ColumnIndices, __Pyx_memviewslice __pyx_v_A_IndexPointer, __Pyx_memviewslice __pyx_v_v, int const __pyx_v_n, int const __pyx_v_m, double const __pyx_v_Tolerance, __Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_beta) {
  ...
  /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":120
 *     cdef int UseSparse
 *     cdef int i,j,k
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":125
 *     if A is None:
 *         if (A_Data is None) or (A_ColumnIndices is None) or (A_IndexPointer is None):
 *             printf('ERROR: All components of sparse matrix are not provided.\n')             # <<<<<<<<<<<<<<
 *             fflush(stdout)
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":127
 *             printf('ERROR: All components of sparse matrix are not provided.\n')
 *             fflush(stdout)
 *             exit(1)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":129
 *             exit(1)
 *         else:
 *             UseSparse = 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  __pyx_t_3 = 0;
  __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CopyVector((&(*((double const  *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_3 * __pyx_v_v.strides[0]) )))), __pyx_v_n, __pyx_v_r);
 ...
 */
  __pyx_t_3 = 0;
  *((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm(__pyx_v_r, __pyx_v_n);
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":152
 * 
 *         # Normalize r and save to the j-th column of V
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             V[j*n+i] = r[i] / beta[j]
 ...
 */
      __pyx_t_3 = __pyx_v_j;
      (__pyx_v_V[((__pyx_v_j * __pyx_v_n) + __pyx_v_i)]) = ((__pyx_v_r[__pyx_v_i]) / (*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) ))));
    }

    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":156
 * 
 *         # Multiply A to the j-th column of V, written into r
 *         if UseSparse:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":161
 *         else:
 *             # Dense matrix-vector multiplication
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":165
 *         if j > 0:
 *             # Subtract from r the V[:,j-1]*beta[j]
 *             for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
        __pyx_t_3 = __pyx_v_j;
        (__pyx_v_r[__pyx_v_i]) = ((__pyx_v_r[__pyx_v_i]) - ((__pyx_v_V[(((__pyx_v_j - 1) * __pyx_v_n) + __pyx_v_i)]) * (*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) )))));
      }
 ...
 */
    __pyx_t_3 = __pyx_v_j;
    *((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_3 * __pyx_v_alpha.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_InnerProduct((&(__pyx_v_V[(__pyx_v_j * __pyx_v_n)])), __pyx_v_r, __pyx_v_n);

    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":172
 * 
 *         # Subtract from r the vector V[:,j]*alpha[j]
 *         for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_3 = __pyx_v_j;
      (__pyx_v_r[__pyx_v_i]) = ((__pyx_v_r[__pyx_v_i]) - ((__pyx_v_V[((__pyx_v_j * __pyx_v_n) + __pyx_v_i)]) * (*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_3 * __pyx_v_alpha.strides[0]) )))));
    }
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm(__pyx_v_r, __pyx_v_n);
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":179
 * 
 *         # Exit if beta got very small
 ...
 */
    __pyx_t_3 = (__pyx_v_j + 1);
    __pyx_t_1 = ((((*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_3 * __pyx_v_beta.strides[0]) ))) * (__pyx_v_j + 1)) < __pyx_v_Tolerance) != 0);
    if (__pyx_t_1) {
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":184
 *     # Free dynamic memory
 *     free(V)
 *     free(r)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":186
 *     free(r)
 * 
 *     return LanczosCounter             # <<<<<<<<<<<<<<
 */
