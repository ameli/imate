...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel",
        "sources": [
            "/home/sia/work/ADCP/Noise-Estimation/code/TraceInv/TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx"
        ]
    },
    "module_name": "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel"
}
END: Cython Metadata */
...
#define __PYX_HAVE__TraceInv___LinearAlgebra__LanczosTridiagonalization_Parallel
#define __PYX_HAVE_API__TraceInv___LinearAlgebra__LanczosTridiagonalization_Parallel
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx",
  "stringsource",
};
...
static double (*__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_InnerProduct)(double const *, double const *, int const ); /*proto*/
...
#define __Pyx_MODULE_NAME "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel"
extern int __pyx_module_is_main_TraceInv___LinearAlgebra__LanczosTridiagonalization_Parallel;
int __pyx_module_is_main_TraceInv___LinearAlgebra__LanczosTridiagonalization_Parallel = 0;

/* Implementation of 'TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel' */
...
/* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":21
 * @boundscheck(False)
 * @wraparound(False)
...
static int __pyx_f_8TraceInv_14_LinearAlgebra_34LanczosTridiagonalization_Parallel_LanczosTridiagonalization(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_A_Data, __Pyx_memviewslice __pyx_v_A_ColumnIndices, __Pyx_memviewslice __pyx_v_A_IndexPointer, __Pyx_memviewslice __pyx_v_v, int const __pyx_v_n, int const __pyx_v_m, double const __pyx_v_Tolerance, __Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_beta) {
  ...
  #endif
  __Pyx_RefNannySetupContext("LanczosTridiagonalization", 1);

  /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":32
 *         double[:] alpha,
 *         double[:] beta) nogil:
 *     """             # <<<<<<<<<<<<<<
 ...
 */
  /*try:*/ {
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":119
 *     cdef int UseSparse
 *     cdef int i,j,k
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":122
 * 
 *     # Check if the input matrix is sparse
 *     if A is None:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":123
 *     # Check if the input matrix is sparse
 *     if A is None:
 *         if (A_Data is None) or (A_ColumnIndices is None) or (A_IndexPointer is None):             # <<<<<<<<<<<<<<
 *             raise ValueError('All components of sparse matrix are not provided.')
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":124
 *     if A is None:
 *         if (A_Data is None) or (A_ColumnIndices is None) or (A_IndexPointer is None):
 *             raise ValueError('All components of sparse matrix are not provided.')             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        {
            ...
            #endif
            /*try:*/ {
              __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 124, __pyx_L12_error)
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":126
 *             raise ValueError('All components of sparse matrix are not provided.')
 *         else:
 *             UseSparse = 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":128
 *             UseSparse = 1
 *     else:
 *         UseSparse = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":131
 * 
 *     # Allocate 2D array (as 1D array, and coalesced row-wise) to hold orthogonalized vectors
 ...
 *     # Allocate vector r
 */
    __pyx_v_V = ((double *)malloc((((sizeof(double)) * __pyx_v_n) * __pyx_v_m)));

    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":134
 * 
 *     # Allocate vector r
 ...
 *     # Copy v into r
 */
    __pyx_v_r = ((double *)malloc(((sizeof(double)) * __pyx_v_n)));

    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":137
 * 
 *     # Copy v into r
 *     CopyVector(&v[0],n,r)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_4 = 0;
    __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_CopyVector((&(*((double const  *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_4 * __pyx_v_v.strides[0]) )))), __pyx_v_n, __pyx_v_r);

    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":140
 * 
 *     # Initialize beta[0]
 ...
 */
    __pyx_t_4 = 0;
    *((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm(__pyx_v_r, __pyx_v_n);

    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":143
 * 
 *     # In the following, beta[j] means beta[j-1] in the Demmel text
 *     for j in range(m):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":146
 * 
 *         # Update counter
 *         LanczosCounter += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":149
 * 
 *         # Normalize r and save to the j-th column of V
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             V[j*n+i] = r[i] / beta[j]
 ...
 */
      ...
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":150
 *         # Normalize r and save to the j-th column of V
 *         for i in range(n):
 *             V[j*n+i] = r[i] / beta[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_4 = __pyx_v_j;
        (__pyx_v_V[((__pyx_v_j * __pyx_v_n) + __pyx_v_i)]) = ((__pyx_v_r[__pyx_v_i]) / (*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) ))));
      }

      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":153
 * 
 *         # Multiply A to the j-th column of V, written into r
 *         if UseSparse:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":155
 *         if UseSparse:
 *             # Sparse matrix-vector multiplication
 *             SparseMatrixVectorMultiplication(A_Data,A_ColumnIndices,A_IndexPointer,&V[j*n],n,r)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_SparseMatrixVectorMultiplication(__pyx_v_A_Data, __pyx_v_A_ColumnIndices, __pyx_v_A_IndexPointer, (&(__pyx_v_V[(__pyx_v_j * __pyx_v_n)])), __pyx_v_n, __pyx_v_r);
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":158
 *         else:
 *             # Dense matrix-vector multiplication
 ...
 */
      /*else*/ {
        __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_DenseMatrixVectorMultiplication(__pyx_v_A, (&(__pyx_v_V[(__pyx_v_j * __pyx_v_n)])), __pyx_v_n, __pyx_v_n, __pyx_v_r);
      }
      __pyx_L18:;

      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":160
 *             DenseMatrixVectorMultiplication(A,&V[j*n],n,n,r)
 * 
 *         if j > 0:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":162
 *         if j > 0:
 *             # Subtract from r the V[:,j-1]*beta[j]
 *             for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
        ...
        for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
          ...
          /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":163
 *             # Subtract from r the V[:,j-1]*beta[j]
 *             for i in range(n):
 *                 r[i] = r[i] - V[(j-1)*n+i]*beta[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_4 = __pyx_v_j;
          (__pyx_v_r[__pyx_v_i]) = ((__pyx_v_r[__pyx_v_i]) - ((__pyx_v_V[(((__pyx_v_j - 1) * __pyx_v_n) + __pyx_v_i)]) * (*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) )))));
        }
 ...
 */
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":166
 * 
 *         # alpha[j] is V[:,j] dot r
 ...
 */
      __pyx_t_4 = __pyx_v_j;
      *((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_4 * __pyx_v_alpha.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_InnerProduct((&(__pyx_v_V[(__pyx_v_j * __pyx_v_n)])), __pyx_v_r, __pyx_v_n);

      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":169
 * 
 *         # Subtract from r the vector V[:,j]*alpha[j]
 *         for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":170
 *         # Subtract from r the vector V[:,j]*alpha[j]
 *         for i in range(n):
 *             r[i] = r[i] - V[j*n+i]*alpha[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_4 = __pyx_v_j;
        (__pyx_v_r[__pyx_v_i]) = ((__pyx_v_r[__pyx_v_i]) - ((__pyx_v_V[((__pyx_v_j * __pyx_v_n) + __pyx_v_i)]) * (*((double *) ( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_4 * __pyx_v_alpha.strides[0]) )))));
      }

      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":173
 * 
 *         # beta is norm of r
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) )) = __pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_EuclideanNorm(__pyx_v_r, __pyx_v_n);
      ...
      /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":176
 * 
 *         # Exit if beta got very small
 ...
 */
      __pyx_t_4 = (__pyx_v_j + 1);
      __pyx_t_1 = ((((*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_4 * __pyx_v_beta.strides[0]) ))) * (__pyx_v_j + 1)) < __pyx_v_Tolerance) != 0);
      if (__pyx_t_1) {

        /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":177
 *         # Exit if beta got very small
 *         if beta[j+1]*(j+1) < Tolerance:
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":180
 * 
 *     # Free dynamic memory
 *     free(V)             # <<<<<<<<<<<<<<
 *     free(r)
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":181
 *     # Free dynamic memory
 *     free(V)
 *     free(r)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":183
 *     free(r)
 * 
 *     return LanczosCounter             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_WriteUnraisable("TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel.LanczosTridiagonalization", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  #ifdef WITH_THREAD
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_LanczosTridiagonalization_Parallel(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_LanczosTridiagonalization_Parallel},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "LanczosTridiagonalization_Parallel",
    0, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
 ...
 *             UseSparse = 1
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_All_components_of_sparse_matrix); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 124, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("LanczosTridiagonalization", (void (*)(void))__pyx_f_8TraceInv_14_LinearAlgebra_34LanczosTridiagonalization_Parallel_LanczosTridiagonalization, "int (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int const , int const , double const , __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "InnerProduct", (void (**)(void))&__pyx_f_8TraceInv_14_LinearAlgebra_16MatrixOperations_InnerProduct, "double (double const *, double const *, int const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initLanczosTridiagonalization_Parallel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initLanczosTridiagonalization_Parallel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_LanczosTridiagonalization_Parallel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_LanczosTridiagonalization_Parallel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_LanczosTridiagonalization_Parallel(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'LanczosTridiagonalization_Parallel' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_LanczosTridiagonalization_Parallel(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("LanczosTridiagonalization_Parallel", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_TraceInv___LinearAlgebra__LanczosTridiagonalization_Parallel) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel")) {
      if (unlikely(PyDict_SetItemString(modules, "TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "TraceInv/_LinearAlgebra/LanczosTridiagonalization_Parallel.pyx":1
 * # =======             # <<<<<<<<<<<<<<
 * # Imports
 * # =======
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init TraceInv._LinearAlgebra.LanczosTridiagonalization_Parallel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
