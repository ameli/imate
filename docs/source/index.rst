...
The supported GPU micro-architectures and CUDA version for |project| are as follows:

+-----------------+---------+---------+---------+---------+---------+---------+---------+--------+--------+-----------+
| Version \\ Arch | Fermi   | Kepler  | Maxwell | Pascal  | Volta   | Turing  | Ampere  | Ada    | Hopper | Blackwell |
+=================+=========+=========+=========+=========+=========+=========+=========+========+========+===========+
| CUDA 9          |   |n|   |   |n|   |   |n|   |   |n|   |   |n|   |   |n|   |   |n|   |   |n|  |   |n|  |    |n|    |
+-----------------+---------+---------+---------+---------+---------+---------+---------+--------+--------+-----------+
| CUDA 10         |   |n|   |   |y|   |   |y|   |   |y|   |   |y|   |   |y|   |   |n|   |   |n|  |   |n|  |    |n|    |
+-----------------+---------+---------+---------+---------+---------+---------+---------+--------+--------+-----------+
| CUDA 11         |   |n|   |   |n|   |   |n|   |   |y|   |   |y|   |   |y|   |   |y|   |   |y|  |   |y|  |    |n|    |
+-----------------+---------+---------+---------+---------+---------+---------+---------+--------+--------+-----------+
| CUDA 12         |   |n|   |   |n|   |   |n|   |   |y|   |   |y|   |   |y|   |   |y|   |   |y|  |   |y|  |    |y|    |
+-----------------+---------+---------+---------+---------+---------+---------+---------+--------+--------+-----------+
| CUDA 13         |   |n|   |   |n|   |   |n|   |   |n|   |   |n|   |   |y|   |   |y|   |   |y|  |   |y|  |    |y|    |
+-----------------+---------+---------+---------+---------+---------+---------+---------+--------+--------+-----------+
...
.. |tokei-2| image:: https://img.shields.io/badge/code%20lines-91k-blue
   :target: https://github.com/ameli/imate
