...
def toeplitz_trace(a, b, size, gram=False):
    ...
    .. code-block:: python
        ...
        >>> A = toeplitz_trace(a, b, size=6)
        12

        >>> A = toeplitz_trace(a, b, size=6, gram=True)
        69
    """
...
def toeplitz_traceinv(a, b, size, gram=False):
    ...
    .. code-block:: python
        ...
        >>> A = toeplitz_traceinv(a, b, size=6)
        3.0

        >>> A = toeplitz_traceinv(a, b, size=6, gram=True)
        45.148681640625
    """
...
def toeplitz_logdet(a, b, size, gram=False):
    ...
    .. code-block:: python
        ...
        >>> A = toeplitz_logdet(a, b, size=6)
        4.1588830833596715

        >>> A = toeplitz_logdet(a, b, size=6, gram=True)
        8.317766166719343
    """
