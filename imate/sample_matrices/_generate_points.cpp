 ...
 *     Generates a set of points in the unit hypercube.
 */
  __pyx_tuple__21 = PyTuple_Pack(5, __pyx_n_s_size, __pyx_n_s_dimension, __pyx_n_s_grid, __pyx_n_s_num_points, __pyx_n_s_coords); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_imate_sample_matrices__generate, __pyx_n_s_generate_points, 25, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 25, __pyx_L1_error)
  __pyx_tuple__22 = PyTuple_Pack(2, ((PyObject *)__pyx_int_2), ((PyObject *)Py_True)); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 25, __pyx_L1_error)
