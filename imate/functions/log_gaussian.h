...
#ifndef FUNCTIONS_LOG_GAUSSIAN_H_
#define FUNCTIONS_LOG_GAUSSIAN_H_
...
/// \brief   Defines the log-normal probability density function
///          \f[
///              f: \lambda \mapsto \frac{1}{\lambda \sigma \sqrt{2 \pi}}
///              e^{-\frac{1}{2} x^2},
///          \f]
///          where
///          \f[
...
#endif  // FUNCTIONS_LOG_GAUSSIAN_H_
