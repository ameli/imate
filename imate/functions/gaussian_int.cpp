...
GaussianInt::GaussianInt(double mu_, double sigma_)
{
    this->mu = mu_;
    this->sigma = sigma_;
}
...
// =====================
// Gaussian Int function (long double)
// =====================
