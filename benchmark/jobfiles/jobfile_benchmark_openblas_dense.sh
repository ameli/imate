...
$PYTHON_DIR/bin/python ${SCRIPTS_DIR}/benchmark_openblas_dense.py -o True > ${LOG_DIR}/stream_output_with_openblas_dense.txt
#$PYTHON_DIR/bin/python ${SCRIPTS_DIR}/benchmark_openblas_dense.py -o False > ${LOG_DIR}/stream_output_without_openblas_dense.txt
